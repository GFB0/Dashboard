        ...
        {abaAtiva === 'criar' && (
          <div style={{ ...Estilos.card, maxWidth: '850px', margin: '0 auto', borderTop: '4px solid #10b981', padding: '32px' }}>
            ...
            <div style={{ marginTop: '48px', paddingTop: '32px', borderTop: '2px solid #e2e8f0' }}>
              ...
              {/* O Grid que organiza em colunas responsivas */}
                  ...
                  <div key={t.id} style={{ backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e2e8f0', padding: '24px', transition: 'all 0.3s ease', boxShadow: '0 2px 4px rgba(0,0,0,0.02)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', opacity: t.ativo === false ? 0.6 : 1 }}>
                    <div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                        ...
                        {/* BADGE DE STATUS (Pílula Verde/Vermelha) */}
                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '12px', fontWeight: '700', padding: '4px 10px', borderRadius: '20px', backgroundColor: t.ativo === false ? '#fee2e2' : '#dcfce7', color: t.ativo === false ? '#ef4444' : '#16a34a', whiteSpace: 'nowrap' }}>
                           <span style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: t.ativo === false ? '#ef4444' : '#16a34a' }}></span>
